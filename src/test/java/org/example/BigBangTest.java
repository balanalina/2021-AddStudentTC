...
public class BigBangTest extends TestCase {
    ...
    public void addStudent(Student s1){
        assertEquals(1, service.saveStudent(s1.getID(), s1.getNume(), s1.getGrupa()));
    }

    public void addAssignment(Tema a1){
        assertEquals(1, service.saveTema(a1.getID(), a1.getDescriere(), a1.getDeadline(), a1.getStartline()));
    }
